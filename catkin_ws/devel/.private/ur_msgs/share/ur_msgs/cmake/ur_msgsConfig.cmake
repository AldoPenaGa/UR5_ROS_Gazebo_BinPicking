...
if("TRUE" STREQUAL "TRUE")
  set(ur_msgs_SOURCE_PREFIX /home/ap/UR5-Pick-and-Place-Simulation/catkin_ws/src/robot/universal_robot/ur_msgs)
  set(ur_msgs_DEVEL_PREFIX /home/ap/UR5-Pick-and-Place-Simulation/catkin_ws/devel/.private/ur_msgs)
  set(ur_msgs_INSTALL_PREFIX "")
  set(ur_msgs_PREFIX ${ur_msgs_DEVEL_PREFIX})
else()
  set(ur_msgs_SOURCE_PREFIX "")
  set(ur_msgs_DEVEL_PREFIX "")
  set(ur_msgs_INSTALL_PREFIX /home/ap/UR5-Pick-and-Place-Simulation/catkin_ws/install)
...
if(NOT "/home/ap/UR5-Pick-and-Place-Simulation/catkin_ws/devel/.private/ur_msgs/include " STREQUAL " ")
  set(ur_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/ap/UR5-Pick-and-Place-Simulation/catkin_ws/devel/.private/ur_msgs/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ap/UR5-Pick-and-Place-Simulation/catkin_ws/src/robot/universal_robot/ur_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ap/UR5-Pick-and-Place-Simulation/catkin_ws/devel/.private/ur_msgs/lib;/home/ap/UR5-Pick-and-Place-Simulation/catkin_ws/devel/lib;/opt/ros/noetic/lib)
