...
namespace ur_driver
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(URDriverConfig &config, const URDriverConfig &max, const URDriverConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const URDriverConfig &config1, const URDriverConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, URDriverConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const URDriverConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, URDriverConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const URDriverConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const URDriverConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, URDriverConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
