...
selectBrick = None
maxLego = 11
spawn_pos = (-0.45, -0.42, 0.74)  		#center of spawn area
...
def readArgs():
	...
	try:
		...
		print("Uso: .\levelManager.py" \
					+ "\n\t -l | -level: nivel desde el 1 al 4." \
					+ "\n\t -b | -brick: generar un bloque LEGO específico de 0 a 10.")
		exit()
		pass
...
def spawnaLego(brickType=None, rotated=False):
	...
	#generacion de colores por grupo
	#Grupo 1
	#'X1-Y1-Z2': 'ladrillo1x1'
	#'X2-Y2-Z2': 'ladrillo2x2'
	if (brickType == 'X1-Y1-Z2' or brickType == 'X2-Y2-Z2'):
		color = 'Gazebo/SkyBlue'
	#Grupo 2
	#'X1-Y2-Z1': 'ladrillo1x2'
	#'X1-Y2-Z2': 'ladrillo1x2Doble'
	elif (brickType == 'X1-Y2-Z1' or brickType == 'X1-Y2-Z2'):
		color = 'Gazebo/Red'
	#Grupo 3
	#'X1-Y3-Z2': 'ladrillo1x3Doble'
	elif (brickType == 'X1-Y3-Z2'):
		color = 'Gazebo/Green'
	#Grupo 4
	#'X1-Y4-Z1': 'ladrillo1x4'
	#'X1-Y4-Z2': 'ladrillo1x4Doble'
	elif (brickType == 'X1-Y4-Z1' or brickType == 'X1-Y4-Z2'):
		color = 'Gazebo/DarkYellow'
	#Grupo 5
	#'X1-Y2-Z2-CHAMFER': 'chamfer1x2'
	#'X1-Y2-Z2-TWINFILLET': 'twinfillet1x2'
	#'X1-Y3-Z2-FILLET': 'fillet1x3'
	#'X2-Y2-Z2-FILLET': 'fillet2x2'
	elif (brickType == 'X1-Y2-Z2-CHAMFER' or brickType == 'X1-Y2-Z2-TWINFILLET' or brickType == 'X1-Y3-Z2-FILLET' or brickType == 'X2-Y2-Z2-FILLET'):
		color = 'Gazebo/White'
...
def setUpArea(livello=None, selectBrick=None): 	
	...
	try:
		...
		elif(livello == None and selectBrick != None):
			spawnaLego(selectBrick)
		else:
			print("[Error]: selecciona un nivel del 1 al 4")
			return
	except PoseError as err:
		print("[Error]: no hay espacio en el spawning area")
		pass
		
	print(f"Añadido {len(lego)} ladrillos")
...
if __name__ == '__main__':
	...
	try:
		if '/gazebo/spawn_sdf_model' not in rosservice.get_service_list():
			print("Servicios de auxilio Gazebo..")
			rospy.wait_for_service('/gazebo/spawn_sdf_model')
		
		#starting position bricks
		setUpArea(level, selectBrick)
		print("Todo hecho. Listo para empezar.")
	except rosservice.ROSServiceIOException as err:
		print("Sin ejecución maestra de ROS")
		pass
	except rospy.ROSInterruptException as err:
		print(err)
		pass
	except rospy.service.ServiceException:
		print("No hay servicios Gazebo en ejecución")
		pass
	except rospkg.common.ResourceNotFound:
		print(f"Paquete no encontrado: '{package_name}'")
		pass
	except FileNotFoundError as err:
		print(f"Modelo no encontrado: \n{err}")
		print(f"Checar modelo en el folder'{package_name}/lego_models'")
		pass
